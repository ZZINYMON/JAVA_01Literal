...
public class Application03 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 변수의 명명 규칙
        * 1. Compile error를 발생시키는 규칙
        * 1-1. 동일한 범위 내에서 동일한 변수명을 가질 수 없다.
        * 1-2. 예약어는 사용이 불가하다.*
        * 1-3. 변수명은 대/소문자를 구분한다. (자바는 대/소문자를 엄격하게 구분하는 언어이다.)
        * 1-4. 변수명은 숫자로 시작할 수 없다.
        * 1-5. 특수 기호는 '_'와 '$'만 사용 가능하다.(공백 사용x)
        *
        * 2. compile error를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙
        * 2-1. 변수명의 길이 제한은 없다.
        ...
        * 2-6. 전형적인 변수 이름이 있다면 가급적 사용하도록 한다. (ex. point, salary etc)
...
//        int sh@rp = 20;
        ...
        int sdfhkjhkjghksldfkjhasdlfkgjhalsfkhglksdjfhsldkfhlskdjfklsdjflksjdlf;
        ...
        /* 목차 2-8. boolean 형(논리형)은 의문문으로 가급적 긍정형태로 네이밍한다. */
